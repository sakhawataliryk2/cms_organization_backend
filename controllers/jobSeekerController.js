              ...
              <html>
                <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
                  ...
                  <p style="margin-top: 25px;">
                    <a href="${process.env.FRONTEND_URL ? `${process.env.FRONTEND_URL}/dashboard/job-seekers/view?id=${id}&tab=notes` : `https://cms-organization.vercel.app/dashboard/job-seekers/view?id=${id}&tab=notes`}"
